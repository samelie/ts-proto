...
fromPartial<I extends Exact<DeepPartial<Cred>, I>>(object: I): Cred {
      const message = { ...baseCred } as Cred;
...
export class DashStateClientImpl implements DashState {
    ...
    constructor(rpc: Rpc) {
  this.rpc = rpc;this.UserSettings = this.UserSettings.bind(this);this.ActiveUserSettingsStream = this.ActiveUserSettingsStream.bind(this);}
...
export const DashStateChangeUserSettingsStreamDesc: UnaryMethodDefinitionish = {
      ...
      requestType: {
    serializeBinary() {
      return Observable<Cred>.encode(this).finish();
    },
  } as any,
      responseType: {
    deserializeBinary(data: Uint8Array) {
